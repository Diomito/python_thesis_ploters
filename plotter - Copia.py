...
def plot_Hand_data():
    try:
        ...
        plt.bar(hand_df['System Time'], hand_df['Hands on steering wheel:'], label='Hands on steering wheel')        
        ...
        plt.plot(hand_df['System Time'], hand_df['Hands on Navigation:'], label='Hands on Navigation')
        plt.plot(hand_df['System Time'], hand_df['Hands on Shifter:'], label='Hands on Shifter')        
        plt.xlabel('Time')
        plt.ylabel('Values')
        plt.title('Hand Data')
        plt.legend()
...
def plot_heart_data():
    ...
    heart_rates = parsed_data['HeartRate']  # Extract heart rates from parsed_data
    ...
    plt.figure(figsize=(10, 6))
    plt.plot(parsed_data['Timestamp'], parsed_data['HeartRate'], marker='o', linestyle='-')
